...
export const BOOSTER_DEFINITIONS: readonly BoosterDefinition[] = [
  {
    ...
    name: 'Origin',
    shortName: 'ORIGIN',
    description: 'The first breach. Heroes, machines, and legends from the base set.',
    price: 100,
    accent: '#5de1f2',
    accentSoft: '#b9f5fb',
  },
  {
    ...
    description: 'Imperial titans return from exile to settle the oldest score in the Rift.',
    price: 100,
    accent: '#ff6c55',
    accentSoft: '#ffc09f',
  },
