...
export const DECK_PRESETS: readonly DeckPreset[] = [
  {
    ...
    entries: [
      ...
      ['021-ordinal', 3], ['006-dr-breen', 3],
      ['013-citadel', 2], ['031-suppression-protocol', 3], ['062-overwatch-directive', 3],
      ['064-transhuman-conditioning', 2], ['094-pulse-rifle', 2], ['095-stun-baton', 3], ['063-suppressing-fire', 2],
      ['energy-gluon', 14], ['energy-electron', 6], ['energy-neutrino', 2],
    ],
  },
  {
    id: 'citadel-lock',
    ...
    entries: [
      ...
      ['035-cremator', 1], ['036-disaster-spectre', 1], ['048-sniper', 2], ['049-stalker', 2],
      ['082-scanner', 3], ['002-apocalypse', 2],
      ...
      ['energy-neutrino', 7], ['energy-electron', 7], ['energy-gluon', 7], ['energy-boson', 3],
    ],
  },
  {
    id: 'rebel-frequency',
  ...
  },
  {
    ...
    entries: [
      ...
      ['energy-gluon', 9], ['energy-electron', 7], ['energy-muon', 3], ['energy-boson', 1], ['energy-photon', 1],
    ],
  },
  {
    id: 'machine-loop',
    ...
    entries: [
      ...
      ['074-junk-droid', 2], ['076-mining-droid', 3], ['079-retrieval-machine', 2], ['080-rover', 2],
      ...
      ['energy-electron', 12], ['energy-boson', 7], ['energy-gluon', 2],
    ],
  },
  {
    id: 'peoples-champion',
    ...
    entries: [
      ...
      ['066-andy-king', 3], ['067-civilian', 3], ['081-salesman', 3], ['050-stanley-pines', 3], ['019-lola-bunny', 2],
      ['056-contract-with-the-tcr', 3], ['030-splinter-groups', 3], ['055-clearmind', 2],
      ['089-battle-medicine', 3], ['091-herring-bandito', 3],
      ['energy-photon', 8], ['energy-gluon', 7], ['energy-muon', 4], ['energy-electron', 1],
    ],
  },
  {
    id: 'heavy-hitters',
    ...
    entries: [
      ...
      ['002-apocalypse', 2], ['010-soldier-tf2-super', 2],
      ['070-demoman', 3], ['086-soldier-tf2', 3], ['103-lucille-de-labora', 1],
      ['061-one-punch', 3], ['090-deploy-armor', 3], ['089-battle-medicine', 3],
      ['063-suppressing-fire', 3], ['092-keltec-pr57', 2], ['055-clearmind', 1],
      ['energy-boson', 14], ['energy-muon', 4], ['energy-photon', 2], ['energy-gluon', 1], ['energy-neutrino', 1],
    ],
  },
  {
    id: 'grave-signal',
    ...
    entries: [
      ...
      ['012-xehanort', 3], ['018-ebony-maw', 3], ['024-sylas', 3], ['048-sniper', 2],
      ['049-stalker', 2], ['050-stanley-pines', 1], ['051-stewie-griffin', 2], ['105-the-master-of-puppets', 1],
      ...
      ['energy-neutrino', 11], ['energy-electron', 5], ['energy-gluon', 3], ['energy-muon', 3], ['energy-photon', 1],
    ],
  },
  {
    id: 'loaded-dice',
    ...
    entries: [
      ...
      ['051-stewie-griffin', 3], ['026-yoko-littner', 2],
      ['091-herring-bandito', 3], ['092-keltec-pr57', 3], ['060-oblique-blade', 3],
      ['090-deploy-armor', 2], ['059-inter-hyperversal-space', 2],
      ['energy-muon', 10], ['energy-electron', 4], ['energy-boson', 2], ['energy-photon', 2], ['energy-gluon', 1], ['energy-neutrino', 1],
    ],
  },
  {
    ...
    entries: [
      ...
      ['007-garen-crownguard', 2], ['008-jean-luc-picard', 2], ['009-raiden', 1], ['010-soldier-tf2-super', 2],
      ['011-terra', 1], ['012-xehanort', 2], ['020-mark-rutte', 2], ['026-yoko-littner', 2],
      ['039-engineer', 2], ['044-motu', 1], ['054-vale', 2], ['076-mining-droid', 3],
      ['014-hyperversal-gate', 3], ['028-energy-reactor', 3], ['089-battle-medicine', 2], ['055-clearmind', 2],
      ['energy-boson', 7], ['energy-electron', 5], ['energy-gluon', 5],
      ['energy-photon', 3], ['energy-neutrino', 2], ['energy-muon', 2],
    ],
  },
  {
    id: 'solar-flare',
    name: 'Solar Flare',
    faction: 'Luminaries',
    archetype: 'Photon aggro',
    tagline: 'Burn bright. Burn first.',
    description: 'A relentless Photon curve that floods the board with cheap stars and closes with a Cyclops SUPER before the opponent stabilizes.',
    gamePlan: ['Open with one-cost Photon Units', 'Apply pressure every turn without pause', 'Convert a wide board into an X-Tremists Unite finish'],
    complexity: 1,
    featuredCardIds: ['004-cyclops-super', '034-bob-ross', '015-x-tremists-unite'],
    entries: [
      ['065-2d', 3], ['081-salesman', 3], ['034-bob-ross', 3], ['053-tupac', 3], ['038-eminem', 3], ['040-geert-wilders', 2],
      ['017-cyclops-tactician', 3], ['003-barack-obama', 3], ['004-cyclops-super', 1],
      ['015-x-tremists-unite', 2], ['056-contract-with-the-tcr', 2], ['055-clearmind', 2], ['093-narrow-escape', 3],
      ['089-battle-medicine', 2], ['030-splinter-groups', 3],
      ['energy-photon', 13], ['energy-gluon', 6], ['energy-muon', 3],
    ],
  },
  {
    id: 'iron-bulwark',
    ...
    tagline: 'Hold the line. Then advance it.',
    description: 'A grindy Gluon-Boson wall of high-HP bodies, layered Armor, and removal that outlasts aggression before Garen and Apocalypse take over.',
    gamePlan: ['Stall early attacks behind oversized Units', 'Bolt on Armor and clear threats with Suppressing Fire', 'Close the game with a Citadel-backed heavyweight'],
    complexity: 2,
    featuredCardIds: ['007-garen-crownguard', '013-citadel', '090-deploy-armor'],
    entries: [
      ['075-metrocop', 2], ['084-sentry', 3], ['073-guard', 3], ['085-soldier', 3], ['072-grunt', 3], ['087-transport-droid', 3],
      ['071-desert-droid', 2], ['079-retrieval-machine', 2], ['002-apocalypse', 1], ['007-garen-crownguard', 2],
      ['095-stun-baton', 2], ['090-deploy-armor', 3], ['092-keltec-pr57', 2], ['063-suppressing-fire', 3], ['013-citadel', 2],
      ['energy-gluon', 13], ['energy-boson', 9], ['energy-neutrino', 1], ['energy-electron', 1],
    ],
  },
  {
    id: 'shadow-protocol',
    ...
    archetype: 'Backline tempo',
    tagline: 'You never see the shot.',
    description: 'An Electron-Muon strike force that snipes from the Backguard, equips for reach, and uses Infiltration and Zephyr Strike to dictate every trade.',
    gamePlan: ['Deploy cheap Units and safe Backguard snipers', 'Equip Oblique Blade and Strike Gun for extra reach', 'Steal tempo with Infiltration and Zephyr Strike'],
    complexity: 2,
    featuredCardIds: ['048-sniper', '060-oblique-blade', '024-sylas'],
    entries: [
      ['083-scout-droid', 3], ['078-pilot', 3], ['082-scanner', 2], ['048-sniper', 3], ['054-vale', 3], ['043-marksman', 3],
      ['049-stalker', 2], ['024-sylas', 2], ['019-lola-bunny', 3],
      ['060-oblique-blade', 3], ['096-tcr-v02-strike-gun', 3], ['058-infiltration-strike', 3], ['032-zephyr-strike', 2], ['057-incoming-warning', 3],
      ['energy-electron', 13], ['energy-muon', 6], ['energy-gluon', 2], ['energy-neutrino', 1],
    ],
  },
  {
    id: 'command-star',
    name: 'Command Star',
    faction: 'High Command',
    archetype: 'Legends ramp',
    tagline: 'Requisition. Escalate. Command.',
    description: 'A TCR ramp shell that fixes Energy with Mining Droid and Energy Reactor, then overwhelms with premium legends like Picard and Garen ahead of curve.',
    gamePlan: ['Fix and accelerate Energy in the early turns', 'Bridge with efficient Gluon-Electron Units', 'Land oversized legends before the opponent can answer'],
    complexity: 3,
    featuredCardIds: ['007-garen-crownguard', '028-energy-reactor', '008-jean-luc-picard'],
    entries: [
      ['083-scout-droid', 2], ['066-andy-king', 2], ['076-mining-droid', 3], ['020-mark-rutte', 3], ['033-antonije-pusic', 2],
      ['052-tech-specialist', 2], ['088-trooper', 2], ['019-lola-bunny', 3], ['008-jean-luc-picard', 2], ['006-dr-breen', 2], ['007-garen-crownguard', 2],
      ['028-energy-reactor', 3], ['016-zero-hour', 2], ['030-splinter-groups', 3], ['057-incoming-warning', 2],
      ['energy-gluon', 13], ['energy-electron', 8], ['energy-boson', 3], ['energy-photon', 1],
    ],
  },
  {
    id: 'chaos-theory',
    name: 'Chaos Theory',
    faction: 'X-Perience',
    archetype: 'Brawl combo',
    tagline: 'Predictably unpredictable.',
    description: 'A Muon-Boson brawler that overloads the board with beefy bruisers, then converts One Punch and Copycats into explosive, hard-to-math damage.',
    gamePlan: ['Curve out with high-HP Muon and Boson Units', 'Multiply threats with Copycats', 'Spike lethal through One Punch and Squidward Mercenary'],
    complexity: 2,
    featuredCardIds: ['061-one-punch', '104-squidward-mercenary', '022-patlu'],
    entries: [
      ['041-kramer', 3], ['045-murdoc-niccals', 3], ['023-squidward', 3], ['044-motu', 3], ['047-peter-griffin', 3], ['050-stanley-pines', 2],
      ['070-demoman', 3], ['022-patlu', 3], ['077-norm-of-the-north', 1], ['104-squidward-mercenary', 1],
      ['061-one-punch', 3], ['027-copycats', 3], ['091-herring-bandito', 3], ['090-deploy-armor', 2], ['093-narrow-escape', 2],
      ['energy-muon', 11], ['energy-boson', 10], ['energy-photon', 1],
    ],
  },
] as const;
